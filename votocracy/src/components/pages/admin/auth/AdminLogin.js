      ...
      <div className="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
        ...
        {success && (
          ...
          <form>
            ...
            <div className="mt-10">
              <button
                className="bg-gradient-to-r from-violet-700 to-indigo-700 text-gray-100 p-4 w-full rounded-full tracking-wide
          ...
          <div className="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
            ...
            <a className="cursor-pointer text-indigo-600 hover:text-indigo-800" onClick={toRegister}>
              Sign up
            </a>
          </div>
        </div>
